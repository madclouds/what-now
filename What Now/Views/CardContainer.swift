...
class CardContainer: UIView {
    ...
    let currentTaskView = CurrentTaskView()
    let pickTaskView = PickTaskView()
    ...
    init() {
        ...
        contentView.addSubview(currentTaskView)
        currentTaskView.snp.makeConstraints { (make) in
        ...
        pickTaskView.snp.makeConstraints { (make) in
            ...
            make.height.equalTo(self.snp.height)
            make.top.bottom.equalToSuperview()
            make.left.equalTo(currentTaskView.snp.right)
        }
